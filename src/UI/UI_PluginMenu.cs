...
namespace CADLib_Plugin_UI
{
    public partial class UI_PluginMenu : Form, ICADLibPlugin
    {
        ...
        public void TrackInterfaceItems(InterfaceTracker tracker)
        {
            ...
            tracker.Add(new InterfaceItemState(helloToolStripMenuItem, LibConnectionState.Connected, LibFolderState.DoesNotMatter, LibObjectState.DoesNotMatter, LibRequiredPermission.EditParametersRegistry));
